...
abstract class AbstractAmazonS3Driver extends AbstractHierarchicalFilesystemDriver implements StreamableDriverInterface
{
    ...
    public function getSpecificFileInformation(string $fileIdentifier, string $path, string $property)
    {
        return match ($property) {
            ...
            default => throw new \InvalidArgumentException(
                sprintf('The information "%s" is not available.', $property), 1597926187
            ),
        };
    }
